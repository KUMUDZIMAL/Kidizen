              ...
              {submitStatus === 'success' ? (
                ...
                <>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div>
                      <label htmlFor="message" className="block text-kid-base font-kid font-bold text-kid-purple mb-2">
                        Your Message <span className="text-kid-orange">*</span>
                      </label>
                      <textarea
                        id="message"
                        name="message"
                        ...
                        onChange={handleChange}
                        className="block w-full px-4 py-3 border-2 border-kid-blue/30 rounded-kid focus:ring-2 focus:ring-kid-blue focus:border-kid-blue transition duration-300 ease-in-out font-kid text-kid-base"
                    ...
                    <div>
                      <button
                        ...
                        className={`w-full flex justify-center items-center py-4 px-6 border-2 border-transparent rounded-kid text-kid-base font-kid font-bold text-white 
                          ${submitStatus === 'submitting' 
                            ? 'bg-kid-blue/50 cursor-not-allowed' 
                            : 'bg-gradient-to-r from-kid-purple to-kid-pink hover:from-kid-pink hover:to-kid-purple shadow-kid hover:shadow-kid-lg'
                          } 
                          focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-kid-purple transition duration-300 ease-in-out transform hover:scale-105`}
                      >
                        {submitStatus === 'submitting' ? (
                          <>Sending...</>
                        ) : (
