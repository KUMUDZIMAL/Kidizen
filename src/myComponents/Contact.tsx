    ...
    <section className="relative w-full min-h-screen overflow-hidden flex items-center justify-center">
      ...
      <div className="relative w-full max-w-7xl mx-auto px-8 py-16">
        <div className="bg-white/10 backdrop-blur-lg border border-white/20 rounded-3xl shadow-xl p-12">
          ...
          {/* CTA Section */}
          <div className="bg-gradient-to-r from-kid-blue/20 to-kid-purple/20 rounded-kid-xl p-12 text-center border-2 border-kid-cream">
            <div className="max-w-3xl mx-auto">
              <Award className="w-12 h-12 mx-auto mb-6 text-kid-purple" />
              <h2 className="text-kid-4xl font-kid font-bold text-kid-purple mb-6">
                Ready to Transform Your Career?
              </h2>
              <p className="text-kid-xl text-kid-blue/70 font-kid mb-8">
                Join thousands of women who have accelerated their careers through mentorship.
              </p>
              <div className="flex flex-col sm:flex-row gap-6 justify-center">
                <Button asChild variant="kid" size="lg" className="font-kid font-bold text-kid-lg px-10 py-4">
                  <Link href="/scheduler">
                ...
                <Button asChild variant="outline" size="lg" className="font-kid font-bold text-kid-lg px-10 py-4 border-2 border-kid-purple text-kid-purple hover:bg-kid-purple/10 transition-colors duration-300">
