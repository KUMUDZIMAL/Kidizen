...
const GameMap = () => {
  ...
  // Define levels directly in the component
  const levels = [
    {
      id: 1,
      name: "Introduction",
      description: "Learn the basics of your rights.",
      position: { x: 20, y: 30 },
      questions: [{}, {}, {}],
      pointsToEarn: 50,
      completed: false,
    ...
    },
    {
      ...
      description: "Understand your right to express yourself.",
      position: { x: 50, y: 60 },
      questions: [{}, {}, {}, {}],
      pointsToEarn: 70,
      completed: false,
    ...
    },
    {
      ...
      description: "Explore your educational rights.",
      position: { x: 80, y: 40 },
      questions: [{}, {}, {}, {}, {}],
      pointsToEarn: 90,
      completed: false,
